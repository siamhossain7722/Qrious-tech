...
urlpatterns = [
    ...
    path('superadmin/payments/export/pdf/', accounts_views.export_payments_pdf),
    path('admin-payments/<int:payment_id>/delete/', accounts_views.superadmin_delete_payment, name='superadmin_delete_payment'),
    path('superadmin/payments/<int:payment_id>/delete/', accounts_views.superadmin_delete_payment),
